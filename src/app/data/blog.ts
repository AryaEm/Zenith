...
export const blogPosts: BlogPost[] = [
    {
        ...
        date: "2024-03-15",
        excerpt: "Learn how to build your first Next.js application step by step.",
        content: `Next.js is a powerful React framework that makes it easy to build server-side rendered and statically generated web applications.
                ...
                Next.js project and creating your first pages.`
    },
    {
        id: 2,
        ...
        content: `CSS is gaining powers with recent web evolution. And it is very clever
